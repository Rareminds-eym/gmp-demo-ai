 ...
 * @param {string} environment - Database environment (GMP, MC, FSQM)
 * @returns {Object} - Object containing data and any errors
 */
export const fetchStageData = async (email = null, limit = null, environment = 'GMP') => {
  try {
 ...
 */
export const fetchUserStageData = async (email, environment = 'GMP') => {
  try {
    const supabase = getSupabaseClient(environment);
